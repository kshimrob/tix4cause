...
DEFINE('WSDL', 'http://tnwebservices.ticketnetwork.com/TNWebService/v3.1/WSDL/tnwebservicestringinputs.xml');


/*
DEFINE('WSDL', 'http://tnwebservices-test.ticketnetwork.com/TNWebService/v3.1/WSDL/tnwebservicestringinputs.xml');
*/
DEFINE('WEB_CONF_ID', 12563); // make sure you change this to your config id
